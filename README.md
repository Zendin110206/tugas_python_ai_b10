...
- **Git**
  Covers terminal-based editing practice from the Git section of the certification track, currently focused on Nano file editing through the Build a Castle workshop.
